...
{
    unsigned int DE:1;            /**< \brief [0:0] Debug Enable - DE (rh) */
...
{
    Ifx_Strict_32Bit reserved_0:1;    /**< \brief [0:0] \internal Reserved */
    unsigned int DCBYP:1;         /**< \brief [1:1] Data Cache Bypass - DCBYP (rw) */
...
{
    Ifx_Strict_32Bit reserved_0:1;    /**< \brief [0:0] \internal Reserved */
    unsigned int PCBYP:1;         /**< \brief [1:1] Program Cache Bypass - PCBYP (rw) */
    Ifx_Strict_32Bit reserved_2:30;    /**< \brief [31:2] \internal Reserved */
} Ifx_CPU_PCON0_Bits;
